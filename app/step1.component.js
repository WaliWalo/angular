...
var Step1Component = (function () {
    function Step1Component(router, location, countyService) {
        this.router = router;
        this.location = location;
        this.countyService = countyService;
        this.val1 = 'Odeon Cinema';
        this.msgs = [];
        this.activeIndex = 1;
    }
    Step1Component.prototype.onSelect = function (cinema) {
    ...
    Step1Component = __decorate([
        ...
        __metadata('design:paramtypes', [router_1.Router, common_1.Location, county_service_1.CountyService])
    ], Step1Component);
